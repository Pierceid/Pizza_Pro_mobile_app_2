...
fun NavGraph(navController: NavHostController) {
    ...
    NavHost(
        ...
        authNavGraph(navController = navController, sharedState = sharedState, onSharedEvent = onSharedEvent)
        composable(HOME_GRAPH_ROUTE) {
            HomeScreen(sharedState = sharedState, onSharedEvent = onSharedEvent)
        }
    }
}
